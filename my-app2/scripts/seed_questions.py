...
easy_questions = [
    ...
    },
    {
        ...
        "explanation": "נפתח סוגריים: 3x - 6 = 15, נוסיף 6 לשני האגפים: 3x = 21, נחלק ב-3: x = 7",
        "timeLimit": 30
    },
    {
        "id": "algebra_3",
    ...
    },
    {
        ...
        "explanation": "סכום זוויות במשולש הוא 180°. במשולש ישר זווית יש זווית של 90°. לכן: 180° - 90° - 30° = 60°",
        "timeLimit": 30
    },
    {
        "id": "geometry_5",
    ...
    },
    {
        ...
        "explanation": "tan 45° = 1 כי במשולש ישר זווית עם זווית של 45°, שני הניצבים שווים",
        "timeLimit": 30
    },
    {
        "id": "trigonometry_4",
    ...
    # Statistics Questions (5)
    {
        ...
        "explanation": "בסדרה עם מספר אי-זוגי של איברים, החציון הוא האיבר האמצעי. במקרה זה - 6",
        "timeLimit": 30
    },
    {
        "id": "statistics_2",
    ...
    # Calculus Questions (5)
    {
        ...
        "explanation": "נגזרת של x בחזקת n היא n כפול x בחזקת (n-1). במקרה זה n=2, לכן התוצאה היא 2x",
        "timeLimit": 30
    },
    {
        "id": "calculus_2",
    ...
    },
    {
        ...
        "explanation": "נגזרת של x בחזקת n היא n כפול x בחזקת (n-1). במקרה זה n=3, לכן התוצאה היא 3x²",
        "timeLimit": 30
    },
    {
        "id": "calculus_5",
...
def upload_questions():
    ...
    print("Starting to upload questions...")
    ...
    print("Finished uploading questions")
