...
export default function LearningItem({ item, index, isCompleted, toggleStepCompletion, totalItems }) {
  return (
    <div 
      ...
      <div className="p-8 pt-20">
        ...
        <div className="panels rounded-xl p-6 mb-6 border border-gray-200 dark:border-gray-600">
          <div className="flex items-start space-x-3 space-x-reverse">
            ...
            <p className="text-color leading-relaxed text-lg">{item.explanation}</p>
          </div>
        </div>
        ...
        {item.videoUrl && (
          <div className="panels rounded-xl p-6 mb-6 border border-red-200 dark:border-red-400 bg-red-50 dark:bg-red-900">
            <div className="flex items-center space-x-2 space-x-reverse mb-4">
              ...
              <h3 className="font-bold text-gray-800 dark:text-red-100 text-lg">סרטון הסבר</h3>
            </div>
