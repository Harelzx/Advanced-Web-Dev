...
export default function NextPracticeCard({ sessionNumber }) {
  ...
  return (
    <div className="panels p-4 sm:p-6 rounded-lg shadow w-full h-full flex flex-col border border-gray-200 dark:border-gray-600" dir="rtl">
      <h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-2">התרגול הבא שלך</h3>
