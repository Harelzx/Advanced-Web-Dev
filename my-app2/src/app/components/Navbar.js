...
export default function Navbar({
  ...
  return (
    <nav className="navbar-custom w-full backdrop-blur-md shadow-lg border-b z-[30] fixed top-0 left-0">
        ...
        <div className="hidden md:flex items-center justify-between w-full">
          {isDashboard ? (
            ...
            <div className="flex items-center gap-4">
              <span className="navbar-text-custom">ברוך שובך, {userName}!</span>
      ...
      {open && (
        <ul
          className="navbar-custom navbar-text-custom md:hidden backdrop-blur-md flex flex-col space-y-1 p-4 border-t"
          dir="rtl"
        >
          {isDashboard ? (
            ...
            <>
              ...
              <li>
                <button
                  onClick={() => {
                    (userRole === "teacher" ? onAddStudent : onAddChild)();
                    setOpen(false);
                  }}
            ...
            <>
              <li>
                <Link
                  href="/Main_Page"
                  className="navbar-button-custom block py-3 px-4 rounded-lg text-right transition-all duration-200 font-medium"
          ...
          <li
            ...
            style={{ borderTopColor: "var(--navbar-border)" }}
          >
            <Link
              href="/"
              className="block py-3 px-4 navbar-button-custom rounded-lg text-right font-medium transition-all duration-200"
              onClick={() => setOpen(false)}
            >
              התנתקות
            </Link>
