        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 flex items-center justify-center p-4" dir="rtl">
            <div className="max-w-2xl w-full panels/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 text-center">
                ...
                <p className="text-gray-700 mb-8 max-w-lg mx-auto">
                    תוכנית האימונים בנויה מ-9 תרגולים ברמות קושי עולות: 3 תרגולים ראשונים ברמה קלה, 3 ברמה בינונית, ו-3 אחרונים ברמת בגרות מאתגרת.
                </p>
                
                <div className="bg-indigo-50/50 p-6 rounded-2xl mb-8 text-right space-y-4">
                    <h3 className="text-lg font-bold text-gray-800 mb-3">כמה דגשים לפני שמתחילים:</h3>
                    <div className="flex items-start">
                        <span className="text-xl text-indigo-500 ml-3 pt-1">🎯</span>
                        <p className="text-gray-700"><strong>תרגול מותאם אישית:</strong> השאלות נבחרות עבורך על בסיס התוצאות מהמבחן הראשוני, ומתמקדות בנושאים בהם נדרש חיזוק.</p>
                    </div>
                    <div className="flex items-start">
                        <span className="text-xl text-indigo-500 ml-3 pt-1">💡</span>
                        <p className="text-gray-700"><strong>עקביות היא המפתח:</strong> מומלץ לבצע תרגול אחד ביום, עד שלושה בשבוע.</p>
                    </div>
                    <div className="flex items-start">
                        <span className="text-xl text-indigo-500 ml-3 pt-1">🤔</span>
