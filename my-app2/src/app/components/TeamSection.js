  ...
  return (
    <section className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        {showTitle && (
          <h2 className="text-3xl font-bold text-center mb-3" style={{ color: 'var(--text-color)' }}>
            הצוות המפתח
          </h2>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="rounded-2xl p-6 shadow-lg border text-center hover:shadow-xl transition-shadow duration-300" style={{ 
              ...
              <div className="w-24 h-24 mx-auto mb-4 rounded-full overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                ...
                <div className={`text-white text-2xl font-bold ${member.image ? 'hidden' : 'flex'} items-center justify-center w-full h-full`}>
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200"
              >
